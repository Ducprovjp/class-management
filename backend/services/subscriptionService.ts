...
import { CreateSubscriptionRequestDto, SubscriptionResponseDto, UseSessionRequestDto } from '../types/dtos/subscription.dto';
...
export class SubscriptionService {
  ...
  async useSession(id: string, data: UseSessionRequestDto): Promise<SubscriptionResponseDto> {
    try {
